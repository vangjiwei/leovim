...
echo 'vim -p  ~/.vimrc.local main/common.vim main/settings/boostup.vim main/packsync/pack.vim vscode/neovim.vim jetbrains/idea.vim' >> $HOME/.local/bin/leovim
...
echo 'nvim -p ~/.vimrc.local main/common.vim main/settings/boostup.vim main/packsync/pack.vim vscode/neovim.vim jetbrains/idea.vim' >> $HOME/.local/bin/leonvim
