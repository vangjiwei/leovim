...
function! s:Repeat(cnt, inner, visual, operator)
  let l:mapping = (a:inner ? "\<Plug>(argumentobjI)" : "\<Plug>(argumentobjA)")
  if !a:visual
...
vnoremap <silent> <Plug>(argumentobjI) :<C-U>call <SID>MotionArgument(1, 1)<CR>
vnoremap <silent> <Plug>(argumentobjA) :<C-U>call <SID>MotionArgument(0, 1)<CR>
onoremap <silent> <Plug>(argumentobjI) :<C-U>call <SID>MotionArgument(1, 0)<CR>
onoremap <silent> <Plug>(argumentobjA) :<C-U>call <SID>MotionArgument(0, 0)<CR>
if ! hasmapto('<Plug>(argumentobjI)', 'v')
  xmap ia <Plug>(argumentobjI)
endif
if ! hasmapto('<Plug>(argumentobjA)', 'v')
  xmap aa <Plug>(argumentobjA)
endif
if ! hasmapto('<Plug>(argumentobjI)', 'o')
  omap ia <Plug>(argumentobjI)
endif
if ! hasmapto('<Plug>(argumentobjA)', 'o')
  omap aa <Plug>(argumentobjA)
endif
